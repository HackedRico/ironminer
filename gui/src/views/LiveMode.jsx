...
import { MOCK_FEEDS, MOCK_ALERTS } from '../utils/mockData'
...
export default function LiveMode() {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 24 }}>
      ...
      <div>
        <div style={{
          ...
          <div style={{ position: 'absolute', top: 0, left: 0, right: 0, padding: '12px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'linear-gradient(rgba(0,0,0,0.7), transparent)' }}>
            ...
            {usingMock && <span style={{ fontSize: 9, fontFamily: 'var(--mono)', color: '#F59E0B' }}>DEMO DATA</span>}
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: '#64748B' }}>
              {feed?.worker ? 'Press and hold to talk' : 'This is a fixed camera — broadcast to all workers on site'}
            </div>
          </div>
      ...
      {/* ── Right sidebar: Feed grid + Active alerts ─────────────────────── */}
      <div>
